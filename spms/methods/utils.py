	...
	for row in visit_goal_doc.target_breakdown:
		for item in sales_invoice.items:
			if item.item_code == row.item:
				...
				break
	visit_goal_doc.achieved += operator * sales_invoice.base_net_total
	visit_goal_doc.save()
